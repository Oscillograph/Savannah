...
//				ImGui::ShowStackToolWindow();
				...
				{
					if (ImGui::BeginTable("Middle Table", (m_SkillsRegistry->GetGroupsNames().size() + 1), ImGuiTableFlags_RowBg | ImGuiTableFlags_ScrollX, {TEXT_BASE_WIDTH * 140, TEXT_BASE_HEIGHT * 15}))
					{
